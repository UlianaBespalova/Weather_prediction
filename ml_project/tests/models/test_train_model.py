...
class TestFitPredictModel(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.model_params = ModelParams(save_path="ml_project/test/help_test_data/test_model_lgbm_classifier.pickle",
    ...
    def test_save_metrics_to_json(self):
        ...
        metrics_path = os.path.abspath('ml_project/tests/help_test_data/test_metrics.json')
    ...
    def test_serialize_model(self):
        ...
        path = os.path.abspath('ml_project/tests/help_test_data/test_model_lgbm_classifier.pickle')
